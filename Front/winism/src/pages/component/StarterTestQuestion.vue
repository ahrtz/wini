<template>
    <div class="wrapper" v-bind:style="{height:window.height+'px'}">
        <div class="opa-05" v-bind:style="{height:window.height+'px'}">
            <div class="center" v-bind:style="{height:window.height+'px'}">
                ...
                <div class="selectArea">
                    <a v-on:click="clickans1()">
                        <div
                            class="selectBox1"
                            v-bind:style="{height:window.width*0.15+'px',width:window.width*0.15+'px'}"
                            v-html="ans1"/>
                    </a>
