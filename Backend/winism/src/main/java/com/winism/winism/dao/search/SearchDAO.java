...
public interface SearchDAO extends JpaRepository<wineList, String> {
	...
	@Param("ALCOHOL1") String ALCOHOL1, @Param("ALCOHOL2") String ALCOHOL2, @Param("SWEETNESS") String SWEETNESS,
	@Param("ACIDITY") String ACIDITY, @Param("TANNIN") String TANNIN, @Param("BODY") String BODY);
